...
resource "aws_s3_object" "partition_structure_examples" {
  for_each = var.create_partition_examples ? toset([
    "${var.primary_data_prefix}year=2024/month=01/day=01/hour=00/.keep",
    "${var.primary_data_prefix}year=2024/month=01/day=01/hour=01/.keep",
    "processed/year=2024/month=01/day=01/hour=00/.keep",
